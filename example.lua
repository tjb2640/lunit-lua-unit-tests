...
-- Defining a test: Must come last. Tip: Tests should really have at least 1 Assert() chain to be useful.
Suite.DefineTest("mytable.fizBuz", "It should check fizbuz results", function()
    mytable.fizBuz(3)
